...
% ==============================================================
dir
file_name=input(' Enter training filename in single quote: ');
...
disp('Is there a testing file? ');
testys=input('Enter 1 or return for Yes (default), others for no: ');
if isempty(testys), testys=1; end
if testys==1,
   file_name=input(' Enter test filename in single quote: ');
   eval(['load ' file_name]);   % load training file
...
% ==============================================================
disp('=============================================================');
alphaval=input('learning rate (between 0 and 1, default = 0.1) alpha = ');
if isempty(alphaval), alphaval=0.1; end
