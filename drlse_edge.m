...
for k=1:iter
	...
	if 1
	  subplot(221), imagesc(phi, [-1 1]);
	  subplot(222), imagesc(timestep*mu*distRegTerm, [-1 1]);
	  subplot(223), imagesc(timestep*lambda*edgeTerm, [-1 1]);
	  subplot(224), imagesc(timestep*alfa*areaTerm, [-1 1]);
	  drawnow; pause();
	end
