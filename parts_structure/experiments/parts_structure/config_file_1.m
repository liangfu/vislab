...
PATHSTR = '/home/liangfu/workspace/vislab/parts_structure';

%%% Directory holding the experiment 
RUN_DIR = [PATHSTR '/experiments/parts_structure']; % [ '/home/fergus/demos/experiments/parts_structure' ];
%RUN_DIR = [ 'C:\MATLAB6p5\demos\experiments\parts_structure' ];

%%% Directory holding all the source images
IMAGE_DIR = [PATHSTR '/images']; % [ '/home/fergus/demos/images' ];

%% Codebook directory - holds all VQ codebooks 
CODEBOOK_DIR = [PATHSTR '/codebooks/']; % [ '/home/fergus/demos/codebooks/' ];   
